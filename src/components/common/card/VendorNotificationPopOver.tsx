...
import { UseGetVendorNotification } from "@/hooks/vendor/UseGetVendorNotification"
import { formatNotificaionTime } from "@/utils/helpers/ConvertNotificationTIme"



export const VendorNotificationPopover: React.FC = () => {
  const [notificationOpen, setNotificationOpen] = useState(false)

 
const { data: queryData, isLoading, error } = UseGetVendorNotification()
