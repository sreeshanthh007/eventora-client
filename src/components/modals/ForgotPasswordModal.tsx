...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({ isOpen, onClose, onSuccess, role }) => {
            ...
            <div className="flex flex-col items-center space-y-4 pt-4">
              <div
                className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${
                  step === "email" ? "bg-black" : "bg-gray-800"
                }`}
              >
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 focus:border-black rounded-lg transition-colors duration-200"
                  />
                </div>
                ...
                <div className="flex space-x-3">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-black hover:bg-gray-900 text-white font-semibold py-3 rounded-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
                  >
                    {isLoading ? (
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 focus:border-black rounded-lg transition-colors duration-200 text-center text-lg font-mono tracking-widest"
                    maxLength={6}
                  />
                </div>
                ...
                <div className="text-center">
                  {timeLeft > 0 ? (
                    <p className="text-sm text-gray-500 font-thin">
                      Resend code in <span className="font-semibold text-black font-serif">{timeLeft}s</span>
                    </p>
                  ) : (
                    <button
                      onClick={handleResendOTP}
                      className="text-sm text-black hover:text-gray-700 font-semibold transition-colors duration-200"
                    >
                      Resend OTP
                    </button>
                  )}
                ...
                <div className="flex space-x-3">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gray-800 hover:bg-black text-white font-semibold py-3 rounded-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
                  >
                    {isLoading ? (
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
