...
import { NotificationPopover } from "../common/card/NotificationPopOver"
    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="text-2xl font-serif md:text-3xl text-gray-900 transition-colors duration-200">
            EVENTORA
          </Link>
                    ...
                    <div className="py-6 border-b border-gray-200">
                      <div className="flex items-center space-x-3">
                        <Avatar className="h-12 w-12 border border-gray-200">
                          <AvatarImage
                            src={client.profileImage ? getCloudinaryImageUrl(client.profileImage) : "/placeholder"}
                          />
