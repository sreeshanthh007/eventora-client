...
// import VerificationModal from "../modals/VendorVerificationModal"
...
export const AuthForm = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, actions) => {
      if (isRegister) {
        if(role=="vendor" && type=="register"){
          // if(!backIdImage || !frontIdImage){
          //   toast.error("please upload both front and back ID images for verification")
          //   return
          // }
        }
          ...
          {/* {type === "register" && role === "vendor" && (
            <div className="space-y-1">
              <Button
                ...
                className="w-full bg-gray-200 text-gray-800 hover:bg-gray-300 h-14 text-base tracking-wider font-medium rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
              >
