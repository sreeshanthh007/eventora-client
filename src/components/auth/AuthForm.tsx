...
import { Eye, EyeOff, UserIcon, Phone, Mail, Lock,  ChromeIcon as Google} from "lucide-react"
  ...
  return (
    ...
    <div className="space-y-6">
      <form className="space-y-5" onSubmit={formik.handleSubmit}>
        ...
        <Button
          className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 h-14 text-base tracking-wider font-medium rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl hover:bg-gray-50"
          type="button"
