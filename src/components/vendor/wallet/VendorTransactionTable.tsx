              ...
              <TableBody>
                {filtered.map((tx) => (
                  ...
                  >
                    ...
                    <TableCell className={`text-sm font-semibold ${getAmountColor(tx.amount)}`}>
                    ...
                    <TableCell className="text-sm text-muted-foreground">{tx.paymentType}</TableCell>
                    <TableCell className="text-sm text-muted-foreground">{tx.paymentFor}</TableCell>
                    <TableCell className="capitalize">{tx.paymentStatus}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
