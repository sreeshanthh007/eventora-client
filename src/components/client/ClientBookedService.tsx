...
interface Props {
  ...
  searchTerm: string
  onChatWithVendor?: (vendorId: string, vendorName: string) => void
}
...
export function ClientBookedServices({
  bookings,
  totalPages,
  isLoading,
  currentPage,
      ...
      <CardContent className="p-0">
        {isLoading ? (
          ...
          <div className="text-center py-10">
            ...
            {searchTerm && <p className="text-muted-foreground text-sm mt-1">Try adjusting your search terms.</p>}
          </div>
        ) : (
          <>
                ...
                <Table className="w-full">
                  <TableHeader>
                    <TableRow className="bg-gray-100">
                      ...
                      <TableHead className="font-semibold whitespace-nowrap">Booking Slot</TableHead>
                  ...
                  <TableBody>
                    {bookings.map((booking) => {
                      ...
                      const displayPaymentStatus =
                        booking.paymentStatus === "successfull" ? "successfull" : booking.paymentStatus
                      ...
                      return (
                        <TableRow key={service.id} className="hover:bg-gray-50">
                          ...
                          <TableCell className="whitespace-nowrap">
                            <div className="flex items-center gap-3">
                              <Avatar className="h-10 w-10">
                                <AvatarImage
                                  src={service.vendorProfilePicture || "/placeholder.svg"}
                          ...
                          <TableCell>
                            <div className="space-y-1">
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                                ...
                                <a href={`mailto:${service.vendorEmail}`} className="hover:text-blue-600 truncate">
                                  {service.vendorEmail}
                                </a>
                              </div>
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          {/* Booking ID */}
                          <TableCell>
                            <p className="text-gray-600 font-mono text-sm whitespace-nowrap">{service.bookingId}</p>
                          </TableCell>
                          ...
                          <TableCell className="whitespace-nowrap">
                           ...
                           {service.paymentStatus === "successfull" && service.rawStatus!=="cancelled" && (
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={() => handleChatWithVendor(service.vendorId)}
                                className="gap-1"
                              >
                              ...
                              {service.rawStatus !== "completed" &&
                                service.rawStatus !== "cancelled" &&
                                service.rawStatus !== "ongoing" && (
                                  <Button
                                    variant="destructive"
                                    size="sm"
                                    onClick={() =>
